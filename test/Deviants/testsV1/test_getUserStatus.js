...
describe.only("Test getUserStatus function", function() {
    ...
    it("Test getUserStatus", async() => {
        ...
        expect(await deviantsNFT.getUserStatus(add1.address)).to.equal(30)
        expect(await deviantsNFT.getUserStatus(add2.address)).to.equal(6)
        expect(await deviantsNFT.getUserStatus(add3.address)).to.equal(6)
        expect(await deviantsNFT.getUserStatus(add4.address)).to.equal(6)
        expect(await deviantsNFT.getUserStatus(add5.address)).to.equal(6)
        expect(await deviantsNFT.getUserStatus(add6.address)).to.equal(6)
        expect(await deviantsNFT.getUserStatus(add7.address)).to.equal(6)
