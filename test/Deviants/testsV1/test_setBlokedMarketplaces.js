...
describe.only("Test setBlokedMarketplaces function", function() {
    ...
    it("Test setBlokedMarketplaces", async() => {
        ...
        await deviantsNFT.setBlokedMarketplaces(add2.address, false);
        await deviantsNFT.setBlokedMarketplaces(add2.address, true);
    });

    it("Try setBlokedMarketplaces as a normal user", async() => {
        const { deviantsNFT, deviantsSilverPass, deviantsDimondPass, deviantsGoldPass, deviantsCrimsonPass, add1, add2, add3, add4, add5, add6, add7, payerAccount, receiver } = await loadFixture(resetState);

        try {
            await deviantsNFT.connect(add1).setBlokedMarketplaces(add2.address, false);
        } catch (error) {
