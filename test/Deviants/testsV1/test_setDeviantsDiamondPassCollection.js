...
describe.only("Test setDeviantsDiamondPassCollection function", function() {
    ...
    it("Set setDeviantsDiamondPassCollection", async function() {
        ...
        let actualDimond = await deviantsNFT.deviantsDiamondPassCollection();
        expect(actualDimond).to.equal(deviantsDimondPass.address);

        await deviantsNFT.setDeviantsDiamondPassCollection(deviantsSilverPass.address);
        expect(await deviantsNFT.deviantsDiamondPassCollection()).to.equal(deviantsSilverPass.address);
    })
    ...
    it("Try set setDeviantsDiamondPassCollection as a normal user", async() => {
        ...
        try {
            await deviantsNFT.connect(add1).setDeviantsDiamondPassCollection(deviantsSilverPass.address);
        } catch (error) {
    ...
    it("Set setDeviantsDiamondPassCollection multiple times", async() => {
        ...
        await deviantsNFT.setDeviantsDiamondPassCollection(deviantsDimondPass.address);
        expect(await deviantsNFT.deviantsDiamondPassCollection()).to.equal(deviantsDimondPass.address);
    })
})