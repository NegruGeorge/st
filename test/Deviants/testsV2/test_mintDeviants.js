...
describe("Test base VRF functionality", function() {
    ...
    beforeEach(async() => {
        ...
        await deviantsCrimsonPass.mintBatch([deployer.address], 10)
    ...
    it("Contract should receive Random Numbers and mint Deviants", async() => {
        ...
        deviantsSilverPass.setApprovalForAll(deviantsNFT.address, true);
        deviantsDimondPass.setApprovalForAll(deviantsNFT.address, true);
        deviantsGoldPass.setApprovalForAll(deviantsNFT.address, true);
        deviantsCrimsonPass.setApprovalForAll(deviantsNFT.address, true);

        await deviantsNFT.setPauseMint(false);

        await deviantsNFT.mintDeviants([1], [1], [1], [1]);
        expect(await deviantsNFT.balanceOf(deployer.address)).to.eq(6);
        // await deviantsNFT.mintDeviants([1],[1],[1],[1]);
