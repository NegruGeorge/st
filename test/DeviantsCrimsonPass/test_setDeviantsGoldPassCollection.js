...
let startPhase1 = 1677416493;

describe("DeviantsCrimsonPass setDeviantsGoldPassCollection tests", async function() {
    ...
    it("Set setDeviantsGoldPassCollection", async function() {
        ...
        let actualGold = await deviantsCrimsonPass.deviantsGoldPassCollection();
        expect(actualGold).to.equal(deviantsGoldPass.address);

        await deviantsCrimsonPass.setDeviantsGoldPassCollection(deviantsSilverPass.address);
        expect(await deviantsCrimsonPass.deviantsGoldPassCollection()).to.equal(deviantsSilverPass.address);
    })
    ...
    it("Try set setDeviantsGoldPassCollection as a normal user", async() => {
        ...
        try {
            await deviantsCrimsonPass.connect(add1).setDeviantsGoldPassCollection(deviantsSilverPass.address);
        } catch (error) {
    ...
    it("Set setDeviantsGoldPassCollection multiple times", async() => {
        ...
        await deviantsCrimsonPass.setDeviantsGoldPassCollection(deviantsDimondPass.address);
        expect(await deviantsCrimsonPass.deviantsGoldPassCollection()).to.equal(deviantsDimondPass.address);
    })
